...
// Authorization: Pastikan hanya CHAT_ID kau yang boleh guna
function isAuthorized(msg) {
    if (msg.chat.id.toString() !== CHAT_ID) {
        bot.sendMessage(msg.chat.id, "❌ Akses ditolak. Bot ini hanya untuk pemilik sahaja.");
        return false;
    }
    return true;
}
...
setInterval(() => sendMarketStructure().catch(console.error), 900000);const TelegramBot = require('node-telegram-bot-api');
const axios = require('axios');
const express = require('express');
